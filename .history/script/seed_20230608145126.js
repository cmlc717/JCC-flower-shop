...
async function seed() {
  ...
  const products = await Promise.all([
    Product.create({
      ...
      quantity: 1,
      imageUrl: 'https://thenounproject.com/api/private/icons/3564047/edit/?backgroundShape=SQUARE&backgroundShapeColor=%23000000&backgroundShapeOpacity=0&exportSize=752&flipX=false&flipY=false&foregroundColor=%23000000&foregroundOpacity=1&imageFormat=png&rotation=0'
    }),
    Product.create({
      name: "daisies",
      price: "10.00",
      ...
      quantity: 1,
      imageUrl: 'https://thenounproject.com/api/private/icons/882297/edit/?backgroundShape=SQUARE&backgroundShapeColor=%23000000&backgroundShapeOpacity=0&exportSize=752&flipX=false&flipY=false&foregroundColor=%23000000&foregroundOpacity=1&imageFormat=png&rotation=0'
    }),
    Product.create({
      name: "tulips",
      price: "15.00",
